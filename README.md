...
- **Flow view and agent canvas**: workspace and agents as a connected topology, or a card tree with live mini terminals, a crown on the team coordinator and a pulse when a message routes.
